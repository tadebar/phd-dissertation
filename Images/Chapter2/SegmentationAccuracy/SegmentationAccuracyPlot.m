...
load('F:\Dropbox\Troy Adebar Research Folder\z - Past Experiments and Work\2013 - 01 Doppler Segmentation (TBME 2014)\Segmentation Accuracy\Error');
...
set(gcf,'Color','w')
% Set size
set(hFig,'position',[100 100 1300 400]);
xlabh = get(gca,'XLabel');
set(xlabh,'Position',get(xlabh,'Position') - [600 200 0])
